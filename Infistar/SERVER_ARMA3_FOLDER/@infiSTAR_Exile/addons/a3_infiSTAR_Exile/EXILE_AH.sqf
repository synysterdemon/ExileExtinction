...
INFISTARVERSION='12-Jul-2016 14-20-09 - v0054';
...
if(!_return)exitWith
{
	diag_log format['<infiSTAR.de> %1 - serverCommandPassword NOT SET!   synysterdemon@live.co.uk - 12-Jul-2016 14-20-09 - v0054 - %2 - %3',_t,serverName,productVersion];
...
{
	diag_log format['<infiSTAR.de> %1 - infiSTAR_Exile_AdminMenu.hpp in your MPmission is NOT UPDATED   synysterdemon@live.co.uk - 12-Jul-2016 14-20-09 - v0054 - %2 - %3',_t,serverName,productVersion];
...
{
	_log = format['<infiSTAR.de> %1 - call.fsm missing in your MPmission!    synysterdemon@live.co.uk - 12-Jul-2016 14-20-09 - v0054 - %2 - %3',_t,serverName,productVersion];
...
FNC_A3_RL = compileFinal "
	...
	_buildurl = format['http://htmlload.infistar.de/rl.php?owner=synysterdemon@live.co.uk&owneruid=76561198031739652&infistarversion=12-Jul-2016 14-20-09 - v0054&servername=%1&logname=%2&logentry=%3',serverName,_logname,_logentry];
...
[
	[_admins],
	{
		...
		_devLog = format['infiSTAR.de AHAT %1 - 12-Jul-2016 14-20-09 - v0054 - server running: %2:2520 - AdminNameTag: "+str _AdminNameTag+"',VERSIONCHECKRESULT,call _GET_TIME_TIME];diag_log _devLog;
		"; if(!_HIDE_FROM_PLAYERS)then{ _A3AHstring = _A3AHstring + "
...
_vers = '12-Jul-2016 14-20-09 - v0054';
