...
chatCommands[] =
{
	...
	{"!value","The current HVL is Golden AK's for 125,000ptbs. Golden Taurus for 25,000ptbs. Better Prisoner Magazines for 600ptbs"}
};
...
pathToCustomBillBoardTextures[] =
{
	...
	{"Teamspeak","textures\teamspeak.paa"}
};
...
adminUIDandAccess[] =
{
	...
	},
	{
		{"76561198074255212", "76561198136969157"},	/* Admins with UIDs in this Array have their Access defined in the array below. */
		{
			...
			"MapIcons: AI",
			"Arsenal",	// Adds Arsenal to the mousewheel actions if you press "," on the Numpad!
			"Unconscious","Remove Unconscious"	// Zeus like Lighting from the Air strikes down at selected player / target / location - use ctrl+1 or the menu to use it!
		}
	}
};
